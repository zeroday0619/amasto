...
@pytest.mark.asyncio
async def test_fetch_prefers_latest_schema() -> None:
...
@pytest.mark.asyncio
async def test_fetch_with_only_2_0_schema() -> None:
    base_url = "https://mastodon.example"
    jrd = {
        "links": [
            {"rel": _NODEINFO_SCHEMA_2_0, "href": f"{base_url}/nodeinfo/2.0"},
...
@pytest.mark.asyncio
async def test_fetch_no_supported_schema_raises() -> None:
    base_url = "https://mastodon.example"
    jrd = {
        "links": [
...
@pytest.mark.asyncio
async def test_fetch_empty_links_raises() -> None:
    base_url = "https://mastodon.example"
    jrd: dict = {"links": []}
...
@pytest.mark.asyncio
async def test_fetch_missing_href_raises() -> None:
    base_url = "https://mastodon.example"
    jrd = {
        "links": [
...
@pytest.mark.asyncio
async def test_fetch_jrd_http_error_raises() -> None:
    base_url = "https://mastodon.example"
...
@pytest.mark.asyncio
async def test_fetch_mastodon_social() -> None:
